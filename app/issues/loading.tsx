  ...
  return (
    <main className="mx-auto max-w-2xl px-4 py-8">
      ...
      <div className="mt-3 rounded-2xl bg-white dark:bg-slate-900 p-5 shadow-sm ring-1 ring-slate-200 dark:ring-slate-700">
        ...
        <div className="mt-3 h-7 w-3/4 animate-pulse rounded bg-slate-200 dark:bg-slate-700" />
        <div className="mt-2 h-4 w-1/3 animate-pulse rounded bg-slate-200 dark:bg-slate-700" />
        <div className="mt-4 h-4 w-full animate-pulse rounded bg-slate-200 dark:bg-slate-700" />
        <div className="mt-1.5 h-4 w-5/6 animate-pulse rounded bg-slate-200 dark:bg-slate-700" />
      </div>

      {/* Before/After slider placeholder */}
      <div className="mt-6 aspect-[4/3] w-full animate-pulse rounded-2xl bg-slate-200 dark:bg-slate-700" />
    </main>
  )
}
