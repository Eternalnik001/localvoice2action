...
export default function HomeLoading() {
  return (
    <main className="mx-auto max-w-5xl px-4 py-6">
      {/* Hero placeholder */}
      <div className="h-40 animate-pulse rounded-3xl bg-slate-200 dark:bg-slate-700" />

      {/* Map area grey block */}
      <div className="mt-6 h-[60vh] animate-pulse rounded-2xl bg-slate-200 dark:bg-slate-700" />
